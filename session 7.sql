/*
Write an SQL query to display the total number of orders placed by each user 
in a 'food_orders' table, grouped by user_id.
*/
/*
SELECT
    user_id,
...
Hint: Use GROUP BY and HAVING together to filter the aggregated results.
*/
...
Write an SQL query to find users who have created playlists with a 
